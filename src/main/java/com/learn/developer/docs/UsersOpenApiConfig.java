        ...
        OpenAPI usersProxyOpenAPI() {
                Schema<?> userSchema = new Schema<>()
                                ...
                                .addProperty("createdAt",
                                                new Schema<String>().type("string").example("2025-08-27T06:35:12Z"));

                Schema<?> userCreateSchema = new Schema<>()
                                .type("object")
                ...
                Content arrayJson = new Content().addMediaType(
                                ...
                                new MediaType().schema(new ArraySchema().items(userSchema)));
                ...
                Operation getUser = new Operation()
                                ...
                                .responses(new ApiResponses()
                                                .addApiResponse("200",
                                                                new ApiResponse().description("OK").content(oneJson))
